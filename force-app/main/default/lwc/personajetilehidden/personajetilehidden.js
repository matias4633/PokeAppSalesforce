...
const fondos = [roja, verde, blanca, blanca, amarilla, azul, azul, 
                verdefluor, negro, cobre, cobre, cobre, rosa, naranja,
                violeta, violeta, violeta, grisoscuro];
const fondosString = ["Fire", 'Grass', 'Normal', 'Flying', 'Electric', 
                    'Water', 'Ice', 'Bug', 'Dark', 'Rock', 'Dragon', 'Ground',
                    'Fairy', 'Fighting', 'Poison', 'Psychic', 'Ghost', 'Steel'];
...
export default class PersonajeTilehidden extends LightningElement {
    ...
    renderedCallback() {
        ...
        function revelarTrivia() { //Animacion al mostrar la respuesta de la trivia
            if (!this.mostrar) {
        ...
        idExt.addEventListener('click', reiniciarTrivia);
    }
}